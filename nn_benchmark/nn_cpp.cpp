...
namespace nn
{
            ...
            const int itot, const int jtot, const int ktot)
    {
        ...
        Eigen::Matrix<TF, Eigen::Dynamic, 1> v0(375);
        Eigen::Matrix<TF, Eigen::Dynamic, Eigen::Dynamic> M0(375, 80);
        Eigen::Matrix<TF, Eigen::Dynamic, 1> b0(80);
        Eigen::Matrix<TF, Eigen::Dynamic, 1> v1(80);
        Eigen::Matrix<TF, Eigen::Dynamic, Eigen::Dynamic> M1(80, 18);
